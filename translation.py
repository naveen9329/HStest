...
<tt>☀️For More Help 👉 /help to know how to use me</tt>
    ...
    UPGRADE_TEXT = "<tt>No upgrade Features available 😶!</tt> /Donate"
...
URL | filename | username | password"""
    ...
    NOT_AUTH_USER_TEXT_FILE_SIZE = "Detected File Size: {}. Free Users can only upload: {}\nPlease /upgrade your subscription.\nIf you think this is a bug, please contact <a href='https://telegram.dog/ThankTelegram'>@maxxwizard_bot</a>"
